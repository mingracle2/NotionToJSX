...
interface Content {
  ...
  description: string;
  creatorId: string;
  creator?: UserProfileWithId;
  authorIds: string[];
  content_json?: any;
  content_html?: string;
  content_searchText?: string;
  createdAt: any;
  updatedAt: any;
  ogTitle?: string;
...
interface UserProfileDoc {
  ...
  userEventLogsCount?: number;
  createdAt: any;
  updatedAt: any;
}

interface UserProfileWithId extends UserProfileDoc {
  id: string;
}

export interface NotionRenderedContentDoc extends Content {
...
export interface NotionImageMetaDoc {
  blockId: string;
  imageTitle: string;
...
export interface NotionRenderedContent extends NotionRenderedContentDoc {
  id: string;
}
